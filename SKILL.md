---
name: nonprofit_proposal_go_no_go_engine
description: Turn incomplete nonprofit project inputs into a donor-aligned proposal package, a transparent evidence trail, and a defensible Go / Conditional Go / No-Go submission decision.
---
